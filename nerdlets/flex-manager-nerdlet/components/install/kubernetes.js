                    ...
                    <Segment inverted>
                        ...
                        <Segment inverted>
                            <List relaxed bulleted>
                                <List.Item>
                                    Build your customized Docker Image as in the Docker Install Steps.
                                </List.Item>
                                <List.Item>
                                    If using Container Discovery, ensure the container_discovery parameter is set to true in "nri-flex-config.yml".<br/>
                                    <a rel="noopener noreferrer" target="_blank" href="https://github.com/newrelic/nri-flex/wiki/Service-Discovery#V2-Container-Discovery">View the documentation for more detail on how containers are targeted.</a>
