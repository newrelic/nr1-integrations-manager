                ...
                <Grid.Column>
                    <Segment inverted>
                        <List bulleted relaxed>
                            <List.Item>
                                Linux: <a rel="noopener noreferrer" target="_blank" href={linuxLink}>{linuxName}</a>
                            </List.Item>
                            <List.Item>
                                Mac: <a rel="noopener noreferrer" target="_blank" href={darwinLink}>{darwinName}</a>
                            </List.Item>
                            <List.Item>
                                Windows: <a rel="noopener noreferrer" target="_blank" href={winLink}>{winName}</a>
                            </List.Item>
                        </List>
                    </Segment>
                </Grid.Column>
